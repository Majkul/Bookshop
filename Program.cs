                    ...
                    while (wybor != "6"){
                        ...
                        switch(wybor){
                            ...
                            case "3":
                                ...
                                break;
                            case "4":
                                Console.WriteLine("Wybierz zamówienie do opłacenia:");
                                foreach(Zamowienie zamowienie in klient.Zamowienia){
                                    if(zamowienie.Status == "Oczekujace na zaplate"){
                                        Console.WriteLine(zamowienie);
                                    }
                                }
                                int numer_zamowienia = int.Parse(Console.ReadLine());
                                try{
                                    klient.zaplac(klient.Zamowienia[numer_zamowienia]);
                                }
                                catch(Exception e){
                                    Console.WriteLine(e.Message);
                                }
                            ...
                            case "5":
                                ...
                                foreach(Zamowienie zamowienie in klient.Zamowienia){
                                    Console.WriteLine(i+". Zamówienie:\n");
                ...
                Kurier kurier;
                    ...
                    while(wybor != "6"){
                        ...
                        switch (wybor){
                            case "1":
                                i = 0;
                                Console.WriteLine("Zamówienia do realizacji:");
                                foreach(Zamowienie zamowienie in magazyn.ZamowieniaDoRealizacji){
                                    Console.WriteLine(i+". "+zamowienie);
                                }
